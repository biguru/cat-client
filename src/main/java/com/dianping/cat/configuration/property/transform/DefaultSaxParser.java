...
import static com.dianping.cat.configuration.property.Constants.ENTITY_PROPERTY_CONFIG;
...
public class DefaultSaxParser extends DefaultHandler {
   ...
   public static PropertyConfig parse(InputStream in) throws SAXException, IOException {
      return parseEntity(PropertyConfig.class, new InputSource(removeBOM(in)));
   }

   public static PropertyConfig parse(Reader reader) throws SAXException, IOException {
      return parseEntity(PropertyConfig.class, new InputSource(removeBOM(reader)));
   }

   public static PropertyConfig parse(String xml) throws SAXException, IOException {
      return parseEntity(PropertyConfig.class, new InputSource(new StringReader(removeBOM(xml))));
   }
   ...
   private void parseRoot(String qName, Attributes attributes) throws SAXException {
      if (ENTITY_PROPERTY_CONFIG.equals(qName)) {
         PropertyConfig propertyConfig = m_maker.buildPropertyConfig(attributes);

         m_entity = propertyConfig;
         m_objs.push(propertyConfig);
         m_tags.push(qName);
